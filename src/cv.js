var cv = {
  ...
  about: [
    ...
    {
      section: "Aspiration",
      text: "Aspiration to take my strong technical knowledge, stakeholder management and overall IT experience, and apply it to designing and delivering Cloud Technologies as a Cloud Architect. Initially passing the Caltech Post Graduate Program in Cloud Computing and later passing the AWS Solutions Architect – Associate certification. Working towards securing the associated certifications for Microsoft Azure Architect Design.",
      order: 1,
    },
    {
  ...
  skills: [
    ...
    {
      "skill title": "Application / Other Skills",
      skills: [
  ...
  experience: [
    {
      ...
      project:
        "Leading the Digital Platform of 9 squads, we are delivering multiple digital products to serve Clients, Client Onboarding, Relationship Managers, and Operations Teams.",
    ...
    },
    {
      ...
      project:
        "Payment, chat and Advisory functionality through the respective digital portals, including taking on taskforces for Data feed generation to support IAM Clients.",
      ...
      achievements:
        "Delivered the Secure Communication tool and RM initiated transfers.",
      order: 1,
    },
    {
      start: "01-Jul-2018",
      ...
      project:
        "The Bank of New York (BNYM) Clearer move was the migration of Fixed Income clearing functions to BNYM as the previous clearer was unable to align to ANZ strategic direction and support STP capability.",
      ...
      achievements:
        "Delivered the functionality to enable BNYM as the clearing agent under tight time pressures within 5 months.",
      order: 2,
    },
    {
      start: "01-Nov-2017",
      ...
      project:
        "eOnboarding project scope was to build a new channel to apply for Markets products.  The Online Application form as a new entry point for Markets customers to apply for Markets Products.  The Online Application form then connected into existing Markets Onboarding Systems.",
    ...
    },
    {
      ...
      project:
        "DSU Project implemented the use of Filenet to the current GoldTier Markets Onboarding application to ensure the project met the standard security requirements for Customer Document Storage.",
      ...
      achievements:
        "Seamless delivery of the document storage solution to meet security requirements for document storage, setup the application for future growth, reduce risk on production hardware due to no longer requiring to store documentation on local servers and reduced storage costs being consolidated on shared servers.",
      order: 4,
    },
    {
      start: "01-Nov-2016",
      ...
      project:
        "Scope of this project was to include FX Corp & Commercial counterparties onto the newly implemented Settlement engine to increase the STP settlements rate committed to the Australian Securities and Investment Commission.",
      ...
      achievements:
        "Delivery plan was completed with a well-defined resourcing and delivery approach, although due to funding cuts and competing priorities, the project was put on hold due and rescheduled to be delivered in the next financial year.",
      order: 5,
    },
    {
      start: "01-Apr-2016",
      ...
      project:
        "Upgrade the stand-alone facilities server coming to end of life and set the ground work for a consolidated multi location Access system.",
      ...
      achievements:
        "Seamless delivery of shared application across numerous sites in Singapore and single location in Bangalore to enable access administration across numerous sites from any one location.",
      order: 6,
    },
    {
      start: "01-Sep-2015",
      ...
      achievements:
        "Approval of investment case and completion of the delivery plan ready to execute.  Due to lack of funding the project was put on hold but packaged in readiness once funding was obtained.",
      order: 7,
    },
    {
      start: "01-Oct-2014",
      ...
      project:
        "Implement the building blocks for Interbank Payment STP in the Vietnam hub.  This was the first step to move away from manual payment transfer and handling.",
      ...
      achievements:
        "Successful delivery of project and implementation of infrastructure and application components to manage large volumes of transactions daily.",
      order: 8,
    },
    {
      start: "01-Sep-2014",
      ...
      project:
        "Continued rollout of GoldTier, the Thomson Reuters built application to meet Onboarding, KYC, AML, OTC/Dodd Frank and FATCA requirements for Australia, UK, Hong Kong, and Singapore entities.",
      ...
      achievements:
        "Successful delivery of Hong Kong and Singapore policies overcoming application performance issues to ensure smooth delivery and no production impacts.",
      order: 9,
    },
    {
      start: "01-May-2014",
      ...
      title: "SKY Project",
      project:
        "Leveraging off the pricing grid setup in the Derivatives Valuation Rebuild project, this project developed the application components to facilitate the re-pricing of Derivatives incorporating CVA / FVA calculation.",
      ...
      achievements:
        "Fast tracked delivery of infrastructure across London, Australia and Singapore to support the successful implementation of the pricing engine while adhering to the high implementation and change standards.  This meant large reduction in required capital due to more accurate pricing.",
      order: 10,
    },
    {
      start: "01-Oct-2012",
      ...
      project:
        "OTC Reform was to meet the regulatory requirements of the Dodd-Frank regulations.",
      ...
      achievements:
        "Successful delivery of reporting requirements for US, Hong Kong, Australia, Japan and Europe regulators.  This delivery meant ANZ was one of the first Australian banks to be Dodd-Frank compliant.  Huge time pressures and potential financial impacts meant teams needed to be very Agile and dynamic to quickly synthesise requirements from Business, Compliance and Legal teams to deliver in regular releases.",
      order: 11,
    },
    {
      start: "01-Jul-2012",
      ...
      project:
        "Derivatives Valuation Rebuild came about due to the need to price trades more accurately with the use CVA and FVA and reduce capital required by ANZ.",
      role: "Manage the end to end delivery and rapid deployment of large computing grids.",
      achievements:
        "Delivery of 2 x 64 node computing grids within 3 months from ordering to stand up.  This grid enabled the application POC of the pricing engine pricing engine.",
      order: 12,
    },
    {
      start: "01-Apr-2011",
      ...
      project:
        "Deliver an in-house build Market Risk Reporting System to perform aggregation, Market Risk simulations and scenarios.",
      ...
      achievements:
        "Successful roll-out in a phased manner based on risk types and simulation / scenario types.  This project removed a large number of uncontrolled and adhoc developed spreadsheets and consolidated all risk calculations in one system.  The system provided new functionality not previously available to manipulate the risk data many ways including slicing and dicing, graphical views, drill-down and report functionality. ",
      order: 13,
    },
    {
      start: "01-Dec-2010",
      ...
      title: "Murex Upgrade",
      project:
        "Murex 2.11.36 was nearing end of support and required a substantial upgrade to 2.11.42 due to out of life support for the existing version and new functional requirements.",
    ...
    },
    {
      ...
      project:
        "This large transformation project aimed to align 16 projects in differing stages of the project lifecycle to consolidate into one program and move to one technology platform.  This would reduce overall cost and setup a strategic platform for future delivery.",
      role: "Consolidate individual project timelines and costs into an overall program timeline and cost estimation.",
      achievements:
        "We delivered an investment case highlighting the benefits of the consolidation and made it available to be assessed for funding at the next investment slate steering group.",
      order: 15,
    },
    {
      start: "01-Mar-2009",
  ...
  certifcations: [
    ...
    },
    {
      ...
      course:
        "Occupational Studies - Recreational Leadership and Fitness Instruction",
      order: 2,
    },
    {
      start: "01-Feb-1988",
